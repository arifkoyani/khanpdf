...
const webApplicationSchema = {
  ...
  featureList: [
    "Convert public webpage URLs to PDF",
    "Convert public image links to PDF",
    "Convert public HTML pages to PDF",
    "Convert public text files to PDF",
    "Convert public JSON files to PDF",
    "Convert public Github repos to PDF",
    "Custom page margins",
    "Paper size selection",
    "Portrait and landscape orientation",
    "Download converted PDF",
    "Open PDF in a new tab",
    "Send and Received PDF link by email",
    "No signup required",
    "Free to use",
  ],
};
