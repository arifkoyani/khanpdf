...
import { Mail, MessageCircle, Globe, Calendar, AlertCircle, Clock} from "lucide-react";
 ...
 export default function Contact() {
  ...
  <Link
    ...
    className="inline-flex items-center rounded-xl border border-[#0d1117] bg-[#0d1117] px-4 py-2 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:opacity-90"
  >
    GitHub
  </Link>
